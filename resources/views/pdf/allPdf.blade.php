            ...
            <div style="background-color: #fff; color: #000; border-radius: 5px;">
                <div style="padding: 20px; min-height: 100vh;">
                    ...
                    <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 30%; text-align: right;">
                                <p style="margin-bottom: 0; font-weight: bold; font-size: 12px;">#{{$transactions[0]->uni_transaction_id}}</p>
                    ...
                    <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 70%; vertical-align: top; padding-right: 20px;">
                                ...
                                <p style="font-size: 12px; font-weight: 600; margin: 0 0 5px;">{{$transactions[0]->pet->petname}}</p>

                                <p style="font-size: 12px; margin: 0 0 5px;">{{$transactions[0]->user->state}}</p>
                                <p style="font-size: 12px; margin: 0 0 5px;">{{$transactions[0]->user->city}}</p>
                            ...
                            <td style="width: 30%; vertical-align: top; text-align: right;">
                                <h6 style="font-size: 12px; font-weight: bold; margin: 0;">Date: 
                                    <span style="font-weight: normal;">{{$transactions[0]->created_at}}</span>
                                </h6>
                                <h6 style="font-size: 12px; font-weight: bold; margin: 0;">Payment method: 
                                    <span style="font-weight: normal;">{{$transactions[0]->payment_type}}</span>
                                </h6>
                            </td>
                        </tr>
                    </table>
                            ...
                            <tbody>
                                ...
                                @foreach($transactions as $transaction)
                                    <tr style="background-color: #f8f9fa;">
                                        <td style="padding: 8px;">{{$transaction->payment_for}}</td>
                                        <td style="padding: 8px;">  {{$transaction->amount}}</td>
                                        {{-- <td style="padding: 8px;">10%</td> --}}
                                        <td style="padding: 8px; text-align: right;"> {{$transaction->amount}}</td>
                                    </tr>
                                @endforeach
                    ...
                    <div style="display: flex; justify-content: space-between; margin-top: 30px; flex-wrap: wrap; gap: 10px;">
                        ...
                        <div style="text-align: right;">
                            <p style="font-size: 12px; margin: 0;">{{$totalAmount}}</p>
                    ...
                    <div style="text-align: right; margin-top: 20px;">
                        ...
                        <h6 style="font-size: 12px; font-weight: 600; color: #dc3545;"> {{$totalAmount}}</h6>
                    </div>
                </div>
